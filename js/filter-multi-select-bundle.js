(function ($) {
    ...
    $__default['default'].fn.filterMultiSelect = function (args) {
      ...
      if (typeof args.placeholderText === 'undefined') args.placeholderText = 'เลือกรายการ';
      if (typeof args.filterText === 'undefined') args.filterText = 'ค้นหา';
      if (typeof args.selectAllText === 'undefined') args.selectAllText = 'เลือกทั้งหมด';
